...
- CERN Science for Open Data (CS4OD): [webpage](https://openlab.cern/index.php/project/cern-science-open-data?target=_blank) and [repository](https://github.com/CERN/CS4OD)
